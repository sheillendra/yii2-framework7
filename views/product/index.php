...
use backend\themes\fw7\assets\ProductAsset;
...
<div class="page">
    <div class="navbar">
        <div class="navbar-inner sliding">
            ...
            <div class="title">Product<span class="subtitle">Warehouse System</span></div>
        </div>
    </div>
        ...
        <div class="block accordion-list custom-accordion">
            <div class="accordion-item">
                <div class="accordion-item-toggle">
                    <i class="icon icon-ks-plus">+</i>
                    <i class="icon icon-ks-minus">-</i>
                    <span>Item 1</span>
                </div>
                <div class="accordion-item-content">
                    <p>
