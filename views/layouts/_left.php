    ...
    <div class="page">
        <div class="page-content">
            ...
            <div class="list links-list">
                <?php
                echo Menu::widget([
                    'linkTemplate' => '<a href="{url}" class="link external">{label}</a>',
                    'items' => [
                        ['label' => 'Bank', 'url' => ['/dashboard']],
                        ['label' => 'Modern Trade', 'url' => ['/dashboard/modern-trade']]
                    ]
                ])
                ?>
            </div>
            <div class="block-title">Master</div>
            <div class="list links-list">
                <?php
                echo Menu::widget([
                    'linkTemplate' => '<a href="{url}" class="link external">{label}</a>',
                    'items' => [
                        ...
                        ['label' => 'Merchant', 'url' => ['/merchant']],
                        ['label' => 'Submerchant', 'url' => ['/submerchant']]
                    ]
                ])
                ?>
            </div>
            <div class="block-title">Stock</div>
            <div class="list links-list">
                <?php
                echo Menu::widget([
                    'items' => [
                        ['label' => 'Merchant Stock', 'url' => ['/merchant']],
                        ['label' => 'Allocation Stock', 'url' => ['/submerchant']]
                    ]
                ])
                ?>
            </div>
